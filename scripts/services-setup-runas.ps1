...
# doesn't keep the current working directory though. Added "-Wait" and
# to ensure the elevated process completes before exiting this one, and
# "-ExecutionPolicy Bypass" to be allowed to run this script.
